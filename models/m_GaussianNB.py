...
def run_m_GaussianNB():
    ...
    for i in xrange(len(myDS.p35_list)):
        ...
        cname_to_perfs[prj_name] = ['GaussianNB', t_time, cur_accuracy, cur_error, cur_precision, cur_recall, cur_f1, cur_auroc]
        
    with open(PATH_VARIABLES.cv_5fold_repo_NB, 'a') as f:
